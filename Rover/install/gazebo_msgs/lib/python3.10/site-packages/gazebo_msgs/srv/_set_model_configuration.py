...
class Metaclass_SetModelConfiguration_Event(type):
    """Metaclass of message 'SetModelConfiguration_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_model_configuration__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_model_configuration__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_model_configuration__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_model_configuration__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_model_configuration__event
...
class SetModelConfiguration_Event(metaclass=Metaclass_SetModelConfiguration_Event):
    """Message class 'SetModelConfiguration_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gazebo_msgs/SetModelConfiguration_Request, 1>',
        'response': 'sequence<gazebo_msgs/SetModelConfiguration_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'SetModelConfiguration_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'SetModelConfiguration_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import SetModelConfiguration_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetModelConfiguration_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetModelConfiguration_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import SetModelConfiguration_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetModelConfiguration_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetModelConfiguration_Response'"
...
class Metaclass_SetModelConfiguration(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_model_configuration.Metaclass_SetModelConfiguration_Event._TYPE_SUPPORT is None:
                _set_model_configuration.Metaclass_SetModelConfiguration_Event.__import_type_support__()
...
class SetModelConfiguration(metaclass=Metaclass_SetModelConfiguration):
    ...
    from gazebo_msgs.srv._set_model_configuration import SetModelConfiguration_Event as Event
