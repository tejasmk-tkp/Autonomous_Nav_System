...
class Metaclass_DeleteModel_Event(type):
    """Metaclass of message 'DeleteModel_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__delete_model__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__delete_model__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__delete_model__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__delete_model__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__delete_model__event
...
class DeleteModel_Event(metaclass=Metaclass_DeleteModel_Event):
    """Message class 'DeleteModel_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gazebo_msgs/DeleteModel_Request, 1>',
        'response': 'sequence<gazebo_msgs/DeleteModel_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'DeleteModel_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'DeleteModel_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import DeleteModel_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, DeleteModel_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DeleteModel_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import DeleteModel_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DeleteModel_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DeleteModel_Response'"
...
class Metaclass_DeleteModel(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _delete_model.Metaclass_DeleteModel_Event._TYPE_SUPPORT is None:
                _delete_model.Metaclass_DeleteModel_Event.__import_type_support__()
...
class DeleteModel(metaclass=Metaclass_DeleteModel):
    ...
    from gazebo_msgs.srv._delete_model import DeleteModel_Event as Event
