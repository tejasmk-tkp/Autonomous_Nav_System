...
class Metaclass_GetLinkState_Event(type):
    """Metaclass of message 'GetLinkState_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_link_state__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_link_state__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_link_state__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_link_state__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_link_state__event
...
class GetLinkState_Event(metaclass=Metaclass_GetLinkState_Event):
    """Message class 'GetLinkState_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gazebo_msgs/GetLinkState_Request, 1>',
        'response': 'sequence<gazebo_msgs/GetLinkState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'GetLinkState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'GetLinkState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import GetLinkState_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetLinkState_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetLinkState_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import GetLinkState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetLinkState_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetLinkState_Response'"
...
class Metaclass_GetLinkState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_link_state.Metaclass_GetLinkState_Event._TYPE_SUPPORT is None:
                _get_link_state.Metaclass_GetLinkState_Event.__import_type_support__()
...
class GetLinkState(metaclass=Metaclass_GetLinkState):
    ...
    from gazebo_msgs.srv._get_link_state import GetLinkState_Event as Event
