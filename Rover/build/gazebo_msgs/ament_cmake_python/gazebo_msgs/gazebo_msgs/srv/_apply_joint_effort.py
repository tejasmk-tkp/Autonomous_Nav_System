...
class Metaclass_ApplyJointEffort_Event(type):
    """Metaclass of message 'ApplyJointEffort_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__apply_joint_effort__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__apply_joint_effort__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__apply_joint_effort__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__apply_joint_effort__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__apply_joint_effort__event
...
class ApplyJointEffort_Event(metaclass=Metaclass_ApplyJointEffort_Event):
    """Message class 'ApplyJointEffort_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gazebo_msgs/ApplyJointEffort_Request, 1>',
        'response': 'sequence<gazebo_msgs/ApplyJointEffort_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'ApplyJointEffort_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'ApplyJointEffort_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import ApplyJointEffort_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ApplyJointEffort_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ApplyJointEffort_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import ApplyJointEffort_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ApplyJointEffort_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ApplyJointEffort_Response'"
...
class Metaclass_ApplyJointEffort(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _apply_joint_effort.Metaclass_ApplyJointEffort_Event._TYPE_SUPPORT is None:
                _apply_joint_effort.Metaclass_ApplyJointEffort_Event.__import_type_support__()
...
class ApplyJointEffort(metaclass=Metaclass_ApplyJointEffort):
    ...
    from gazebo_msgs.srv._apply_joint_effort import ApplyJointEffort_Event as Event
