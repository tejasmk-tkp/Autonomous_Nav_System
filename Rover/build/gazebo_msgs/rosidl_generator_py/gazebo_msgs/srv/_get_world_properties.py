...
class Metaclass_GetWorldProperties_Event(type):
    """Metaclass of message 'GetWorldProperties_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_world_properties__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_world_properties__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_world_properties__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_world_properties__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_world_properties__event
...
class GetWorldProperties_Event(metaclass=Metaclass_GetWorldProperties_Event):
    """Message class 'GetWorldProperties_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gazebo_msgs/GetWorldProperties_Request, 1>',
        'response': 'sequence<gazebo_msgs/GetWorldProperties_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'GetWorldProperties_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'GetWorldProperties_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import GetWorldProperties_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetWorldProperties_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetWorldProperties_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import GetWorldProperties_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetWorldProperties_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetWorldProperties_Response'"
...
class Metaclass_GetWorldProperties(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_world_properties.Metaclass_GetWorldProperties_Event._TYPE_SUPPORT is None:
                _get_world_properties.Metaclass_GetWorldProperties_Event.__import_type_support__()
...
class GetWorldProperties(metaclass=Metaclass_GetWorldProperties):
    ...
    from gazebo_msgs.srv._get_world_properties import GetWorldProperties_Event as Event
