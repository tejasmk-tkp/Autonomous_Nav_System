...
class SpawnEntity_Event(metaclass=Metaclass_SpawnEntity_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gazebo_msgs/SpawnEntity_Request, 1>',
        'response': 'sequence<gazebo_msgs/SpawnEntity_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'SpawnEntity_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gazebo_msgs', 'srv'], 'SpawnEntity_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import SpawnEntity_Request
    ...
    def response(self, value):
        if self._check_fields:
            from gazebo_msgs.srv import SpawnEntity_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SpawnEntity(metaclass=Metaclass_SpawnEntity):
    ...
    from gazebo_msgs.srv._spawn_entity import SpawnEntity_Event as Event
