...
static const _SetEntityState_Event_type_support_symbol_names_t _SetEntityState_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, SetEntityState_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, SetEntityState_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, srv, SetEntityState_Event)() {
  return &::gazebo_msgs::srv::rosidl_typesupport_c::SetEntityState_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetEntityState_service_type_support_handle = {
  ...
  &SetEntityState_Request_message_type_support_handle,
  &SetEntityState_Response_message_type_support_handle,
  &SetEntityState_Event_message_type_support_handle,
