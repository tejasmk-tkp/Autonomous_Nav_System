...
static const _GetModelList_Event_type_support_symbol_names_t _GetModelList_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, GetModelList_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetModelList_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, srv, GetModelList_Event)() {
  return &::gazebo_msgs::srv::rosidl_typesupport_c::GetModelList_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetModelList_service_type_support_handle = {
  ...
  &GetModelList_Request_message_type_support_handle,
  &GetModelList_Response_message_type_support_handle,
  &GetModelList_Event_message_type_support_handle,
