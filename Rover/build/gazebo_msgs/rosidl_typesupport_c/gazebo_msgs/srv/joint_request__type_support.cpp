...
static const _JointRequest_Event_type_support_symbol_names_t _JointRequest_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, JointRequest_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, JointRequest_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, srv, JointRequest_Event)() {
  return &::gazebo_msgs::srv::rosidl_typesupport_c::JointRequest_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t JointRequest_service_type_support_handle = {
  ...
  &JointRequest_Request_message_type_support_handle,
  &JointRequest_Response_message_type_support_handle,
  &JointRequest_Event_message_type_support_handle,
