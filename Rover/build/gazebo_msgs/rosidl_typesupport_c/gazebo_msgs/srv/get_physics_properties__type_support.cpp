...
static const _GetPhysicsProperties_Event_type_support_symbol_names_t _GetPhysicsProperties_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, GetPhysicsProperties_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, GetPhysicsProperties_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, srv, GetPhysicsProperties_Event)() {
  return &::gazebo_msgs::srv::rosidl_typesupport_c::GetPhysicsProperties_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetPhysicsProperties_service_type_support_handle = {
  ...
  &GetPhysicsProperties_Request_message_type_support_handle,
  &GetPhysicsProperties_Response_message_type_support_handle,
  &GetPhysicsProperties_Event_message_type_support_handle,
